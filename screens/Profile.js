  ...
  return (
    ...
    >
      ...
      <ScrollView style={styles.viewScroll}>
        ...
        {profile.image ? <Image source={{ uri: profile.image }} style={styles.avatarImage} /> : <View style={styles.avatarEmpty}><Text style={styles.avatarEmptyText}>{profile.firstName && Array.from(profile.firstName)[0]}</Text></View>}
